...
const optionalContracts=[
  ...
  },
  {
    ...
    candidates:['src/urban/urbanAtmosphere.js','src/urban/urbanLightingAtmosphere.js','src/urban/lightingAtmosphere.js','src/urban/urbanLighting.js'],
    tokens:['dispose','getDiagnostics']
  },
  {
    system:'start event',
    candidates:['src/startEventDressing.js','src/urban/urbanStartEvent.js','src/urban/startEvent.js','src/urban/startEventScene.js'],
    tokens:['dispose','getDiagnostics']
  },
  {
